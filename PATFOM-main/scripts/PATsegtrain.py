...
def validate(val_loader, model, epoch, args, writer):
    print('VALIDATE')
    output_path = ".../PATFOM/output_experiment/Seg_data/"
    output_file = os.path.join(output_path, "dice_pre.txt")
    loss_list = []
    dice_list = []
    dice_loss = SoftDiceLoss(batch_dice=True, do_bg=False)
    model.eval()
...
def test(model, args, epoch):
    ...
    save_dir1 = ".../PATFOM/output_experiment/Seg_data/infer/"
    #save_dir2 = ".../PATFOM/output_experiment/Seg_data/label/"
    ...
    if not os.path.exists(join(".../PATFOM/output_experiment/Seg_data/infer/", epoch_str)):
        os.mkdir(join(".../PATFOM/output_experiment/Seg_data/infer/", epoch_str))
    #if not os.path.exists(join(".../PATFOM/output_experiment/Seg_data/label/", epoch_str)):
    #    os.mkdir(join(".../PATFOM/output_experiment/Task1/Seg_data/", epoch_str))
    ...
    for key in test_keys:
        ...
        with torch.no_grad():
            ...
            #nib.save(ni_lb, join(save_dir2, epoch_str, key + '.nii'))
