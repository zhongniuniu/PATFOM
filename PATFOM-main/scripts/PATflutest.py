...
def test(test_loader, model, args):
    ...
    if not os.path.exists(join("/public2/zhongyutian/PATFOM-main/Test_output/PATFlux/")):
        os.mkdir(join("/public2/zhongyutian/PATFOM-main/Test_output/PATFlux/"))
    ...
    for key in test_keys:
        ...
        with torch.no_grad():
            for i, tup in enumerate(test_loader):
                ...
                save_dir1 = "/public2/zhongyutian/PATFOM-main/Test_output/PATFlux"
